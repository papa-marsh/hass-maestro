...
from maestro.triggers._types import TriggerFuncParamsT, TriggerRegistryEntry, TriggerType
from maestro.utils._internal import test_mode_active
from maestro.utils._logging import get_process_id, log, set_process_id
...
class TriggerManager(ABC):
    ...
    def _invoke_func_with_param_handling(
        ...
        try:
            ...
            log.exception(
                "Error executing triggered function",
                module=func.__module__,
