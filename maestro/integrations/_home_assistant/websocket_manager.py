...
from maestro._handlers.types import EventTypeName, get_event_type
from maestro.exceptions import WebSocketConnectionError
from maestro.integrations._home_assistant.types import EventContext, WebSocketEvent
from maestro.integrations._home_assistant.websocket_client import WebSocketClient
from maestro.integrations._redis import RedisClient
from maestro.integrations._state_manager import StateManager
from maestro.utils._dates import IntervalSeconds, local_now, resolve_timestamp
from maestro.utils._logging import build_process_id, log, set_process_id
...
class WebSocketManager:
    ...
    def _handle_event(self, raw_event: dict[str, Any]) -> None:
        ...
        from maestro._app import get_app
