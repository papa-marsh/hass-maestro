...
from maestro.integrations._home_assistant.types import AttributeId, EntityData, EntityId
...
class EntityAttribute[T: (str, int, float, dict, list, bool, datetime)]:
    ...
    def _build_default_test_value(self) -> T:
        ...
        from maestro.testing._mocks import mock_attribute_default_value_map
